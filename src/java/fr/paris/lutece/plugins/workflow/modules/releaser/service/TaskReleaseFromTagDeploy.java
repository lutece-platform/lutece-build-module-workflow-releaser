...
/**
 * Task that delegates to IWorkflowReleaseContextService.deployReleaseFromTag.
 */
public class TaskReleaseFromTagDeploy extends SimpleTask
{
    ...
    public void processTask( int nIdResourceHistory, HttpServletRequest request, Locale locale )
    {
        ...
        _workflowReleaseContextService.deployReleaseFromTag( workflowReleaseContext, locale );
    }
