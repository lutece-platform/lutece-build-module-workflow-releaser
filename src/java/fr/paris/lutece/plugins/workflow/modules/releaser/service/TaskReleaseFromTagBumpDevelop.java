...
/**
 * Task that delegates to IWorkflowReleaseContextService.bumpDevelopAfterReleaseFromTag.
 */
public class TaskReleaseFromTagBumpDevelop extends SimpleTask
{
    ...
    public void processTask( int nIdResourceHistory, HttpServletRequest request, Locale locale )
    {
        ...
        _workflowReleaseContextService.bumpDevelopAfterReleaseFromTag( workflowReleaseContext, locale );
    }
