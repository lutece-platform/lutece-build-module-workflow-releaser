...
/**
 * Task that delegates to IWorkflowReleaseContextService.prepareReleaseFromTag.
 */
public class TaskReleaseFromTagPrepare extends SimpleTask
{
    ...
    public void processTask( int nIdResourceHistory, HttpServletRequest request, Locale locale )
    {
        ...
        _workflowReleaseContextService.prepareReleaseFromTag( workflowReleaseContext, locale );
    }
