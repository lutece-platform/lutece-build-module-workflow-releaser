...
/**
 * Task that delegates to IWorkflowReleaseContextService.updateMasterAfterReleaseFromTag.
 */
public class TaskReleaseFromTagUpdateMaster extends SimpleTask
{
    ...
    public void processTask( int nIdResourceHistory, HttpServletRequest request, Locale locale )
    {
        ...
        _workflowReleaseContextService.updateMasterAfterReleaseFromTag( workflowReleaseContext, locale );
    }
